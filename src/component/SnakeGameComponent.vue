...
div {
  ...
  align-items: center;
  height: 70vh; /* 100% der Bildschirmhöhe */
  margin-top: 50px; /* Verschiebt das Feld 50px nach unten */
}

canvas {
  border: 4px solid #000; /* 4px breite schwarze Umrandung */
}
</style>
